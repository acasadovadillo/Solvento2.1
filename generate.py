  ...
  <div style="max-width:1400px;margin:2rem auto 2rem;width:100%;">
    <div class="dashboard-panel">
      ...
      <div style="position:relative;width:100%;flex-grow:1;min-height:220px;">
        ...
        <div id="neto-date-tooltip" style="position:absolute;transform:translateX(-50%);background:#000000;color:#ffffff;font-size:0.72rem;font-weight:600;padding:0.28rem 0.65rem;border-radius:6px;border:1px solid #2a2d3a;pointer-events:none;display:none;white-space:nowrap;z-index:5;"></div>
      </div>
...
<div class="page" id="page-pasivos">
  ...
  (function(){{
    ...
    function onMove(e) {{
      ...
      tt.style.top = (280 / 300 * rect.height + 6) + 'px';
      tt.style.display = '';
    }}
    function onLeave() {{
